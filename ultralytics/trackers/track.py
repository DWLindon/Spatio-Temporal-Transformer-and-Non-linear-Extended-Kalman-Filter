...
TRACKER_MAP = {"bytetrack": BYTETracker, "botsort": BOTSORT, "auvtrack": AUVByteTracker}
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    if cfg.tracker_type not in {"bytetrack", "botsort", "auvtrack"}:
        raise AssertionError(
            f"Only 'bytetrack', 'botsort', and 'auvtrack' are supported for now, but got '{cfg.tracker_type}'"
        )
